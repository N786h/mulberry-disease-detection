...
function App() {
  ...
  const handleSendMessage = () => {
    ...
    fetch('https://mulberry-backend.onrender.com/chat', {
      method: 'POST',
  ...
  const handleProcessImage = () => {
    ...
    fetch('https://mulberry-backend.onrender.com/upload', {
      method: 'POST',
      body: formData,
    })
      .then((response) => {
      ...
      <div class="center-content">
        ...
        <div class="heading">
          <h1><strong>Mulberry Plant Disease Detection</strong></h1>
            <p>Leaf It to Us! 🍃 Upload Your Mulberry plant leaf Pic Now! 📸 We'll identify and tell you all there is to know about it.</p>
        </div>
      </div>
    </header>
